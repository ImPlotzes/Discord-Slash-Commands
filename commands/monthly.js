...
const structure = {
    name: "monthly",
    description: "Look at the TNT Wizards statistics you got this month.",
    options: [
        {
            name: "username",
...
export async function handleMonthly(request, requestBody) {
    ...
    let response;
    try {
        response = await fetch("https://marmottchen.eu.pythonanywhere.com/" + encodeURIComponent(user) + "/monthly/json");
    } catch(e) {
        await editMessage({
            embeds: [
                {
        ...
        embeds: [
            {
                ...
                description: "Showing the statistics from this month.",
